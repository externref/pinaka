<svelte:head>
    <title>pinaka</title>
    <meta content="pinaka" property="og:title" />
    <meta
...
<script lang="ts">
    const pages = {
        "Shrimad BhagavadGita (श्रीमद् भगवद्गीता)": "/bhagavadgita",
    }
</script>

<div class="font-mono" style="font-size: x-large;">
Available Content
</div>  <hr><br>
<div>

    {#each Object.entries(pages) as [title, pointer]}
    <li>
